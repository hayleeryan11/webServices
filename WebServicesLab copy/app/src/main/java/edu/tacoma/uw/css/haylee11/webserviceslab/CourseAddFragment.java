...
public class CourseAddFragment extends Fragment {
    ...
    private CourseAddListener mListenerAdd;

    private final static String COURSE_ADD_URL = "http://haylee11android.000webhostapp.com/addCourse.php?";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mCourseIdEditText = (EditText) v.findViewById(R.id.enter_course_id);
        mCourseShortDescEditText = (EditText) v.findViewById(R.id.enter_short_desc);
        mCourseLongDescEditText = (EditText) v.findViewById(R.id.enter_long_desc);
        mCoursePrereqsEditText = (EditText) v.findViewById(R.id.enter_prereq);

        FloatingActionButton floatingActionButton = (FloatingActionButton)
                getActivity().findViewById(R.id.fab);
        floatingActionButton.hide();

        Button addCourseButton = (Button) v.findViewById(R.id.button_add);
        addCourseButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String url = buildCourseURL(v);
                mListenerAdd.addCourse(url);
            }
        });
    ...
    public void onAttach(Context context) {
        ...
        if (context instanceof CourseAddListener) {
            mListenerAdd = (CourseAddListener) context;
        } else {
